; Instalador de Ondine (Inno Setup).
; La versión se pasa al compilar:  ISCC.exe /DMyAppVersion=0.2.1 ondine.iss
...
DefaultDirName={localappdata}\Programs\Ondine
DisableProgramGroupPage=yes
DisableDirPage=yes

OutputDir=Output
OutputBaseFilename=Ondine-Setup-{#MyAppVersion}
SetupIconFile=..\src\Ondine\Assets\app.ico
