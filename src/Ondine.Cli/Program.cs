...
// ============================================================================
//  Ondine CLI — mismo motor que la app de escritorio, pero multiplataforma.
...
static int Version()
{
    Console.WriteLine("Ondine CLI " + (typeof(Engine).Assembly.GetName().Version?.ToString(3) ?? "?"));
    return 0;
}
...
Ondine CLI — compresor de vídeo con foco en el ahorro de almacenamiento.

USO
  ondine <orden> [rutas...] [opciones]
