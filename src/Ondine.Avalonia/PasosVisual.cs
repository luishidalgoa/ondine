...
public sealed class PasosVisual
{
    ...
    private static IBrush Rec(string clave) =>
        RecursoDeLaApp(clave) as IBrush ?? Brushes.Gray;
    ...
    public void Terminado(string titulo, string? detalle = null)
    {
        ...
        apagar.Completed += (_, _) => _lista.IsVisible = Visibility.Hidden;
    ...
    private sealed class Paso
    {
        ...
        public Paso(int numero, string rotulo)
        {
            ...
            _detalle = new TextBlock
            {
                ...
                Visibility = false, Margin = new Thickness(0, 1, 0, 0),
            };
        ...
        public void Pendiente()
        {
            ...
            _rotulo.FontWeight = FontWeight.Normal;
        ...
        {
            _detalle.Text = texto;
            _detalle.IsVisible = string.IsNullOrEmpty(texto)
                ? false : true;
        }
        ...
        public void EnCurso()
        {
            ...
            _rotulo.FontWeight = FontWeight.Medium;
            Raiz.Opacity = 1;
            Textos.Opacity = 1;
        }
    ...
    private sealed class Conector
    {
        ...
        private static Path Puntos(IBrush color) => new()
        {
        ...
        public void Apagar()
        {
            _tapa.BeginAnimation(Control.HeightProperty, null);
            _tapa.Height = 0;
        ...
        public void Encender()
        {
            ...
            _tapa.BeginAnimation(Control.HeightProperty,
