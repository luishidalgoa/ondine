...
public partial class VentanaPrincipal : Window
{
    ...
    public VentanaPrincipal()
    {
        ...
        chkTodosIdiomas.IsCheckedChanged += (_, _) => { SincronizarIdiomasDeAudio(); UpdateEstimate(); };
    ...
    private async Task OpenPreferences()
    {
        ...
        var dlg = new Preferencias(_settings, names, aceleraciones,
                                   await _engine.CodificadoresDisponiblesAsync());
    ...
    private async Task SavePreset()
    {
        ...
        user.Add(new Preset
        {
            ...
            ACodec = cboACodec.SelectedIndex, Lang = cboLang.Text,
        });
