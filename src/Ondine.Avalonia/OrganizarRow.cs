...
public sealed class OrganizarRow : INotifyPropertyChanged
{
    ...
    public bool VerDejarIguales => Iguales > 0
        ? true
        : false;
    ...
    public bool VerConfirmarIguales => Confirmables > 0
        ? true
        : false;
    ...
    public bool VerSegmento =>
        SegmentoPildora.Length > 0 ? true : false;
    ...
    public IBrush EstadoFg => Rec($"Org{Tono}");
    public IBrush EstadoBg => Rec($"Org{Tono}Bg");
    ...
    public IBrush PropuestaFg => PropuestaDestacada || Aplicado
        ? Rec("Text")
    ...
    public bool VerRecortar => RecomiendaRecortar ? true : false;
    ...
    public bool VerBorrarCopia => EsRepetido ? true : false;
